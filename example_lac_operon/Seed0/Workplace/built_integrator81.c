...
static double diff_constant[] = {0.3531688292379165};
...
/**************degradation rates*****************/
	 	 rate=0.25484783220827056*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.48081089047386505*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.07350927578663347*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
