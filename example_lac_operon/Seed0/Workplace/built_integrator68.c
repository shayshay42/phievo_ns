...
static double diff_constant[] = {0.13878247560186152};
...
/**************degradation rates*****************/
	 	 rate=0.3232329269527706*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.5545777486202983*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.6324850522812249*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
