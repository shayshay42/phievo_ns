...
static int tracklig[] = {};
static int trackdiff[] = {2};
static double diff_constant[] = {0.8565467255978635};
...
/**************degradation rates*****************/
	 	 rate=0.6616094456435763*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.3764714656340612*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.7046811092203921*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.7309229443495583*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.000786*HillA(history[2][memory][ncell],0.469301,2.277346),0.000000);
	 	 increment=rate;
	 	 ds[2]+=increment;
	}

/**************Protein protein interactions*****************/
	 	 rate=0.363959 * s[0] * s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 ds[0]-=increment;
	 	 ds[3]+=increment;
