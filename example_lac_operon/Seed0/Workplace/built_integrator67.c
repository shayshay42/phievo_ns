...
static double diff_constant[] = {0.03404210755332482};
...
/**************degradation rates*****************/
	 	 rate=0.27840981521636055*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.1134873234223458*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.8231463382936219*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
