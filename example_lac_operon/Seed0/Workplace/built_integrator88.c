...
static double diff_constant[] = {0.4789848587416473};
...
/**************degradation rates*****************/
	 	 rate=0.003476986517350289*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.39558131801264684*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.28748592167809406*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
