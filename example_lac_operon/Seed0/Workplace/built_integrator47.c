...
static double diff_constant[] = {0.5584309375598064, 0.7201619794915146};
...
/**************degradation rates*****************/
	 	 ...
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.9633884753969507*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.5846656260268385*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.47414143650031637*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.646011*HillA(history[2][memory][ncell],0.751126,2.263021),0.000000);
	 	 increment=rate;
	 	 ds[2]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.692058,0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
