...
static double diff_constant[] = {0.9339184922418508};
...
/**************degradation rates*****************/
	 	 rate=0.11986537849757328*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.20070484641085817*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.7054380502780168*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.4104485181101418*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.742610,0.000000);
	 	 increment=rate;
	 	 ds[2]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.007900,0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
